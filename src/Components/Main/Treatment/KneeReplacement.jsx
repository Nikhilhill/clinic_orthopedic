...
import knee_replacement_details from '../../../assets/Images/details/knee_replacement_details.jpg'
  ...
  return (
    <div className="bg-gray-50 py-10 px-4 md:px-10 lg:px-20">
      ...
      <div className="text-center mb-10">
        <h1 className="text-3xl md:text-4xl font-bold text-primary mb-4">Knee Replacement</h1>
